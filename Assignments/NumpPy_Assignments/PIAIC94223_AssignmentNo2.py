...
def function5():
    ...
    z = np.zeros((4,5), dtype="int32") #wrtie your code here
...
def function11():
    ...
    ans = np.where(arr % 2 == 1, -1, arr).copy()#write your code here 
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack(((np.repeat(arr,3,axis=0)), (np.tile(arr,3)))) #write your code here 
